...
export LIBDRM_NOUVEAU_MINOR	:= 2
export LIBDRM_NOUVEAU_PATCH	:= 2
...
lib/libdrm_nouveau.a : lib release $(SOURCES) $(INCLUDES)
...
lib/libdrm_nouveaud.a : lib debug $(SOURCES) $(INCLUDES)
